...
STUDENTS.push(new Student('Petr','Petrov','Petrovich', 100000, 22, testGroup, 19, DISCIPLINES, OLYMPIADS));
STUDENTS.push(new Student('Ivan','Ivanov','Ivanovich', 200000, 21, testGroup, 18, DISCIPLINES, OLYMPIADS));
STUDENTS.push(new Student('Victor','Victorov','Victorovich', 300000, 31, testGroup, 18, DISCIPLINES, OLYMPIADS));
STUDENTS.push(new Student('Vladimir','Vladimirov','Vladimirovich', 400000, 44, testGroup, 20, DISCIPLINES, OLYMPIADS));
STUDENTS.push(new Student('Denis','Denisov','Denisovic', 500000, 27, testGroup, 21, DISCIPLINES, OLYMPIADS));
STUDENTS.push(new Student('Semen','Semenov','Semenovich', 600000, 32, testGroup, 19, DISCIPLINES, OLYMPIADS));
...
PERSONANDSTUDENT.push(new Student('Semen','Semenov','Semenovich', 600000, 32, testGroup, 19, DISCIPLINES, OLYMPIADS));
PERSONANDSTUDENT.push(new Tutor('Victor', 'Victorov', 'Victorovich', 'PhD', 101, 35, 60));
PERSONANDSTUDENT.push(new Person('Soyer','Red', 44));
PERSONANDSTUDENT.push(new Student('Victor','Victorov','Victorovich', 300000, 31, testGroup, 18, DISCIPLINES, OLYMPIADS));
PERSONANDSTUDENT.push(new Tutor('Semen', 'Semenov', 'Semenovich', 'Master', 789, 10, 50));
PERSONANDSTUDENT.push(new Person('Bob','White', 23));
PERSONANDSTUDENT.push(new Student('Ivan','Ivanov','Ivanovich', 200000, 21, testGroup, 18, DISCIPLINES, OLYMPIADS));
