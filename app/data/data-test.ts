...
STUDENTS.push(new Student('Ivan','Ivanov','Ivanovich', 200000, 21, testGroup, 18, DISCIPLINES, OLYMPIADS,SOMETHING));
STUDENTS.push(new Student('Victor','Victorov','Victorovich', 300000, 31, testGroup, 18, DISCIPLINES, OLYMPIADS,SOMETHING));
...
STUDENTS.push(new Student('Semen','Semenov','Semenovich', 600000, 32, testGroup, 19, DISCIPLINES, OLYMPIADS,SOMETHING));
